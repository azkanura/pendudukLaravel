...
@section('content')
    <div class="page-header">
        <h3>
            <span class="text-muted font-weight-light">Ubah Data Kekumuhan
        </h3>
    </div>
    ...
    <script type="text/javascript">
        ...
        function init(){
            ...
            kekumuhan.doc('{{$id}}').get().then(function(doc){
                if(doc && doc.exists){
                    ...
                    $('[name="periode"]').val(data.periode).trigger('change');
                    $('[name="luas_kawasan"]').val(data.luas_kawasan);
                    $('[name="jumlah_penduduk"]').val(data.jumlah_penduduk);
                    $('[name="jumlah_kk"]').val(data.jumlah_kk);
                    $('[name="jumlah_bangunan"]').val(data.jumlah_bangunan);

                    $('[name="bangunan_tak_teratur"]').val(data.bangunan_tak_teratur);
                    $('[name="bangunan_kepadatan"]').val(data.bangunan_kepadatan);
                    $('[name="bangunan_tak_standar"]').val(data.bangunan_tak_standar);

                    $('[name="jalan_tak_terlayani"]').val(data.jalan_tak_terlayani);
                    $('[name="jalan_total_panjang"]').val(data.jalan_total_panjang);
                    $('[name="jalan_rusak"]').val(data.jalan_rusak);

                    $('[name="air_tanpa_akses"]').val(data.air_tanpa_akses);
                    $('[name="air_tak_terpenuhi"]').val(data.air_tak_terpenuhi);

                    $('[name="drainase_genangan"]').val(data.drainase_genangan);
                    $('[name="drainase_tanpa_prasarana"]').val(data.drainase_tanpa_prasarana);
                    $('[name="drainase_tak_terhubung"]').val(data.drainase_tak_terhubung);
                    $('[name="drainase_tak_terpelihara"]').val(data.drainase_tak_terpelihara);
                    $('[name="drainase_konstruksi_buruk"]').val(data.drainase_konstruksi_buruk);

                    $('[name="limbah_tanpa_akses"]').val(data.limbah_tanpa_akses);
                    $('[name="limbah_tak_sesuai"]').val(data.limbah_tak_sesuai);

                    $('[name="sampah_tak_sesuai"]').val(data.sampah_tak_sesuai);
                    $('[name="sampah_tak_standar"]').val(data.sampah_tak_standar);
                    $('[name="sampah_tak_terpelihara"]').val(data.sampah_tak_terpelihara);

                    $('[name="kebakaran_tanpa_prasarana"]').val(data.kebakaran_tanpa_prasarana);
                    $('[name="kebakaran_tanpa_sarana"]').val(data.kebakaran_tanpa_sarana);
                }
            });
        ...
        function saveData(){
            ...
            if(periode && luas_kawasan && jumlah_penduduk && jumlah_kk && jumlah_bangunan && bangunan_tak_teratur && bangunan_kepadatan && bangunan_tak_standar && jalan_tak_terlayani && jalan_total_panjang && jalan_rusak && air_tanpa_akses && air_tak_terpenuhi && drainase_genangan && drainase_tanpa_prasarana && drainase_tak_terhubung && drainase_tak_terpelihara && drainase_konstruksi_buruk && limbah_tanpa_akses && limbah_tak_sesuai && sampah_tak_sesuai && sampah_tak_standar && sampah_tak_terpelihara && kebakaran_tanpa_prasarana && kebakaran_tanpa_sarana) {
                ...
                kekumuhan.doc('{{$id}}').update(data).then(function(){
